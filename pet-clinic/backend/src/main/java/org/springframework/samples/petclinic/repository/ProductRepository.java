...
import org.springframework.samples.petclinic.model.ProductId;
...
public interface ProductRepository {
     ...
     */
    Collection<Product> findByState(int state) throws DataAccessException;
    
    Collection<Product> findAll() throws DataAccessException;
    
    Product findById(ProductId pidServiceId) throws DataAccessException;
